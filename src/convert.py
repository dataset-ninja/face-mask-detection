...
def convert_and_upload_supervisely_project(
    ...
    dataset_path = "/Users/iwatkot/Downloads/ninja/datasets/face-mask-detection"
    ...
    obj_class_without_mask = sly.ObjClass("without_mask", sly.Rectangle)
    obj_class_with_mask = sly.ObjClass("with_mask", sly.Rectangle)
    obj_class_incorrectly = sly.ObjClass("mask_weared_incorrect", sly.Rectangle)

    project = api.project.create(workspace_id, project_name, change_name_if_conflict=True)

    meta = sly.ProjectMeta(
        obj_classes=[obj_class_without_mask, obj_class_with_mask, obj_class_incorrectly]
    )
